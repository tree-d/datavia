...
def test_manual_installation():
    ...
    elevation_wheel = "packages/elevation/dist/datavia_elevation-1.0.1.dev0-py3-none-any.whl"
    
    print("\nChecking wheel files:")
    for wheel, name in [(core_wheel, "Core"), (soil_wheel, "Soil"), (elevation_wheel, "Elevation")]:
