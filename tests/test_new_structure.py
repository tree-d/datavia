...
def test_datavia_core_imports():
    ...
    try:
        ...
        assert False, f"Core datavia import failed: {e}"
...
def test_datavia_pipeline_imports():
    ...
    try:
        ...
        assert False, f"datavia.elevation pipeline import failed: {e}"
    ...
    try:
        ...
        assert False, f"Unexpected error during datavia.soil import: {e}"
